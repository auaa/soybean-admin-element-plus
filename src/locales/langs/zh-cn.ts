  ...
  page: {
    ...
    manage: {
      ...
      valueSet: {
        ...
        status: '状态',
        description: '描述',
        valueSetCodePlaceholder: '请输入值集编码',
        displayNamePlaceholder: '请输入显示名称',
        valuePlaceholder: '请输入值',
        sortPlaceholder: '请输入排序',
        parentPathPlaceholder: '父路径自动生成',
        statusPlaceholder: '请选择状态',
        descriptionPlaceholder: '请输入描述',
        valueSetCodeRequired: '值集编码不能为空',
        valueSetCodeFormat: '值集编码只能包含字母和数字',
        displayNameRequired: '显示名称不能为空',
        valueRequired: '值不能为空',
        statusRequired: '状态不能为空',
        pleaseSelectNode: '请从树中选择一个节点',
        loadDetailError: '加载值集详情失败',
        updateError: '更新值集失败',
        addError: '新增值集失败',
