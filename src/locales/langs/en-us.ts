const local: App.I18n.Schema = {
  ...
  page: {
    ...
    manage: {
      ...
      valueSet: {
        title: 'Value Set Management',
        treeTitle: 'Value Set Tree',
        formTitle: 'Value Set Details',
        ...
        valueSetCodePlaceholder: 'Please enter value set code',
        ...
        parentPathPlaceholder: 'Parent path is auto-generated',
        statusPlaceholder: 'Please select status',
        descriptionPlaceholder: 'Please enter description',
        valueSetCodeRequired: 'Value set code is required',
        valueSetCodeFormat: 'Value set code can only contain letters and numbers',
        displayNameRequired: 'Display name is required',
        valueRequired: 'Value is required',
        statusRequired: 'Status is required',
        pleaseSelectNode: 'Please select a node from the tree',
        loadDetailError: 'Failed to load value set details',
        updateError: 'Failed to update value set',
        addError: 'Failed to add value set',
